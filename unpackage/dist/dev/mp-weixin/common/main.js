...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni, createApp) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 4));__webpack_require__(/*! uni-pages */ 7);__webpack_require__(/*! @dcloudio/uni-stat */ 8);
...
_vue.default.prototype.checkLogin = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(path, type) {var isLogin, isHaveBaby;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
              _auth.default.login());case 2:isLogin = _context.sent;_context.next = 5;return (
              _baby.default.isHaveBaby());case 5:isHaveBaby = _context.sent;if (
            isLogin) {_context.next = 9;break;}
            uni.reLaunch({
              url: "/pages/login/login?backpath=".concat(path, "&type=").concat(type) });return _context.abrupt("return",

            false);case 9:if (

            isHaveBaby) {_context.next = 12;break;}
            uni.reLaunch({
              url: '/pages/baby/addBaby?${path}&type=${type}' });return _context.abrupt("return",

            false);case 12:return _context.abrupt("return",

            true);case 13:case "end":return _context.stop();}}}, _callee, this);}));return function (_x, _x2) {return _ref.apply(this, arguments);};}();
